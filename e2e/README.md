...
public `mkosi_image` rule. Its real-image build and non-empty artifact check
are manually selected because they require the network and the host-kernel
namespace/mount contract; the ordinary smoke suite remains portable.
